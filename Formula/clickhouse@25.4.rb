class ClickhouseAT254 < Formula
  desc "Free analytics DBMS for big data with SQL interface"
  homepage "https://clickhouse.com"
  url "https://github.com/ClickHouse/ClickHouse/releases/download/v25.4.12.9-stable/clickhouse-macos-aarch64",
      verified: "github.com/ClickHouse/ClickHouse/"
  sha256 "7b6f97d45c5c9044819a61165fc384c6a4d4b67abe385c163a3143d2ce684de4"
  license "Apache-2.0"
